...
-- DELETE FROM users WHERE role_id != '00000000-0000-0000-0000-000000000001'; -- Mantiene solo admin
-- DELETE FROM roles WHERE id != '00000000-0000-0000-0000-000000000001'; -- Mantiene solo ruolo admin
...
-- ==================== RESET SEQUENZE ====================
-- Reset delle sequenze per UUID (se necessario)
-- Le tabelle con UUID non hanno sequenze da resettare
